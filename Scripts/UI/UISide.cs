...
public class UISide : MonoBehaviour
{
    ...
    */
    ...
    public void HandleVisualizeButtonClick()
    {
         ...
         */
        GetComponent<UIAnimationManager>().CloseSideUI(true);
        ...
        {
            case 0:
                projectManager.GetComponent<GridAlgorithms>().Initialize("Dijkstra");
                break;
            case 1:
                projectManager.GetComponent<GridAlgorithms>().Initialize("AStar");
                break;
            case 2:
                //clear all weights before running bfs - bfs is unweighted algorithm
                projectManager.GetComponent<GridManager>().RemoveAllWeights();
                projectManager.GetComponent<GridAlgorithms>().Initialize("BFS");
                break;
            case 3:
                //clear all weights before running bfs - bfs is unweighted algorithm
                projectManager.GetComponent<GridManager>().RemoveAllWeights();
                projectManager.GetComponent<GridAlgorithms>().Initialize("DFS");
                break;
        }
    }
    ...
    {
        GetComponent<UIAnimationManager>().CloseSideUI(false);
