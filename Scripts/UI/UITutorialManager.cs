...
public class UITutorialManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        descriptions[0] = "Welcome to PathFinder Unity!\nYou can press the Skip button at any time to get started right away.\n\n" +
            "CONTROLS\nUse arrow keys to move the camera around and use Left Shift and Left Ctrl to zoom in/out";
        ...
        descriptions[4] = "Once you've set everything up you can click the 'VISUALIZE' button and see algorithm of your choice in action!\n" +
