...
public class UIAnimationManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        addWeightButton, removeWeightButton, removeAllWallsButton, removeAllWeightsButton, openTutorialButton, openSettingsButton};
     ...
     */
    public void CloseSideUI(bool isCalledFromAlgo)
    {
        ...
        StartCoroutine(WaitForSideUIClose(isCalledFromAlgo));
    }
    IEnumerator WaitForSideUIClose(bool isCalledFromAlgo)
    {
